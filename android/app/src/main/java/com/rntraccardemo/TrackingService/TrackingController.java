...
import com.rntraccardemo.Activities.StatusActivity;
import com.rntraccardemo.BCReceiver.NetworkManager;
import com.rntraccardemo.Database.DatabaseHelper;
//import com.rntraccardemo.MainFragment;
import com.rntraccardemo.Models.Position;
import com.rntraccardemo.Position.PositionProvider;
import com.rntraccardemo.PositionProviderFactory;
import com.rntraccardemo.ProtocolFormatter;
import com.rntraccardemo.R;
import com.rntraccardemo.RequestManager;
import com.rntraccardemo.SharedPreference.KeyConstants;
...
public class TrackingController implements PositionProvider.PositionListener, NetworkManager.NetworkHandler {
    ...
    public TrackingController(Context context) {
        ...
        url = preferences.getString(KeyConstants.KEY_URL, context.getString(R.string.settings_url_default_value));
        buffer = preferences.getBoolean(KeyConstants.KEY_BUFFER, true);
    }
    ...
    private void read() {
        ...
        databaseHelper.selectPositionAsync(new DatabaseHelper.DatabaseHandler<Position>() {
            ...
            public void onComplete(boolean success, Position result) {
                if (success) {
                    if (result != null) {
                        if (result.getDeviceId().equals(preferences.getString(KeyConstants.KEY_DEVICE, null))) {
                            send(result);
                        } else {
                            delete(result);
                        }
