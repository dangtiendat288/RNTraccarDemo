 ...
 */
package com.rntraccardemo.Position;
...
public abstract class PositionProvider {
    ...
    public PositionProvider(Context context, PositionListener listener) {
        ...
        deviceId = preferences.getString(KeyConstants.KEY_DEVICE, "654321");
        interval = Long.parseLong(preferences.getString(KeyConstants.KEY_INTERVAL, "600")) * 1000;
        distance = Integer.parseInt(preferences.getString(KeyConstants.KEY_DISTANCE, "0"));
        angle = Integer.parseInt(preferences.getString(KeyConstants.KEY_ANGLE, "0"));
    }
