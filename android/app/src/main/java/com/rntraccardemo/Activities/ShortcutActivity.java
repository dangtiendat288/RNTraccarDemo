 ...
 */
package com.rntraccardemo.Activities;
        ...
        PositionProviderFactory.create(this, new PositionProvider.PositionListener() {
            ...
            public void onPositionUpdate(Position position) {
                ...
                String request = ProtocolFormatter.formatRequest(
                        preferences.getString(KeyConstants.KEY_URL, null), position, ALARM_SOS);
            ...
            switch (action) {
                case ACTION_START:
                    PreferenceManager.getDefaultSharedPreferences(this)
                            .edit().putBoolean(KeyConstants.KEY_STATUS, true).apply();
                ...
                case ACTION_STOP:
                    PreferenceManager.getDefaultSharedPreferences(this)
                            .edit().putBoolean(KeyConstants.KEY_STATUS, false).apply();
